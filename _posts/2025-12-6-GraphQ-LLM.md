---
layout: article
title: "GraphQ-LLM: AI Query Tutor for ResilientDB"
author: Aayusha Hadke, Celine John Philip, Sandhya Ganathe, Sophie Quynn, Theodore Pan
tags: ResilientDBGraphQL LLM AI Tutor
aside:
    toc: true
article_header:
  type: overlay
  ...
  background_image:
    ...
    opacity: 0.2
    src: /assets/images/graphq-llm/background.jpeg
...
![Architecture](/assets/images/graphq-llm/architecture.png)
...
**Ready to get started?** Follow the complete setup guide in `TEAM_SETUP.md` from our [GitHub](https://github.com/sophiequynn/graphq-llm) and begin exploring the power of AI-assisted GraphQL development in ResilientDB!
