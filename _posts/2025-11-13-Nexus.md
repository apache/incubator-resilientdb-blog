---
layout: article
title: "Nexus: An Agentic Rag Assistant for ResilientDB and Distibuted Systems Research"
author: Abdel Rahman Ibrahim
tags: Nexus, Agentic, RAG, ResilientDB, Distributed Systems, Generative, AI
aside:
    toc: true
article_header:
  type: overlay
  ...
  background_image:
    gradient: 'linear-gradient(135deg, rgba(71, 0, 167, 0.2), rgba(51, 154, 154, .2))'
    opacity: 0.2
    src: /assets/images/nexus/cover.png
...
![System Architecture](/assets/images/nexus/architecture.png)
...
![Ingestion Pipeline](/assets/images/nexus/ingestion.png)
...
![Streaming and Tooling](/assets/images/nexus/streaming.png)
...
### Research Agent
![Research Agent](/assets/images/nexus/research.png)

### Code Composer Agent
![Code Composer Agent](/assets/images/nexus/agent.png)
